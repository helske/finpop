...
summary_mu <- apply(mu, 2, function(x) c(mean = mean(x), quantile(x, 0.025, 0.975)))
summary_lambda_b <- apply(lambda$lambda_b, 2, function(x) c(mean = mean(x), quantile(x, 0.025, 0.975)))
summary_lambda_d <- apply(lambda$lambda_d, 2, function(x) c(mean = mean(x), quantile(x, 0.025, 0.975)))
